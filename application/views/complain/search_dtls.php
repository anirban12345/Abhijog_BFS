                                                    ...
                                                    <?php $i=1; foreach($complain as $r) { ?>                                                                   
                                                                ...
                                                                <td><?=$i++?></td>
                                                                    ...
                                                                    <?php if(in_array('updatemail',$user_permission)){ ?>                                                                        
                                                                        ...
                                                                        <?php } ?>
                                                                        <?php if(in_array('updatemail',$user_permission)){ ?>                                                                        
                                                                            <a role="button" href="<?=base_url('Complain/refund?q='.urlencode($this->encrypt->encode($complain[0]->c_id)))?>" class="btn waves-effect waves-light btn-success btn-sm" title="Refund"><i class="fas fa-money-bill-alt"></i></a>
                                                                    <?php } ?>
                                                                    </td>
                                                                </tr>                                                                           
                                                            <?php } ?>     
