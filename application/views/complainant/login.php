        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" id="loginmobile">
            <div class="auth-box">
                <div id="loginform">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal m-t-20" action="<?php echo base_url('ComplainantLogin/checklogin')?>" method="post">
                                <!-- CRSF -->
                                <?php 
                                $csrf = array(
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Mobile No" aria-label="Mobile No" aria-describedby="basic-addon1" name="username" id="username" autocomplete="off">
                                    
                                </div>
                                <?php echo form_error('username'); ?>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon2"><i class="ti-pin"></i></span>
                                    </div>
                                ...
                                <div class="form-group text-center">
                                    <div class="col-xs-12 p-b-20">
                                        <button class="btn btn-block btn-md btn-primary" type="submit">Log In</button>
                                    </div>
                                </div>
                                <div class="form-group text-center">
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Don't have an account? <a href="<?=base_url('ComplainantLogin/Register')?>" class="text-info m-l-5"><b>Sign Up</b></a>
                                    </div>
                                </div>
                            </form>
                        </div>
