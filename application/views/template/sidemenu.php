                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <?php if(in_array('createmail',$user_permission)){ ?>
                                <li class="sidebar-item">
                                    <a href="<?=base_url('Complain/userComplain')?>" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu"> User Complains</span>
                                    </a>
                                </li>
                                <?php } ?>
                        ...
                        <li class="sidebar-item">
                            ...
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="fas fa-envelope fa-2x"></i>
                                &nbsp;&nbsp;&nbsp; <span class="hide-menu">Petition</span>
                            </a>
                           
                            <ul aria-expanded="false" class="collapse  first-level">
                                <?php if(in_array('createmail',$user_permission)){ ?>
                                <li class="sidebar-item">
                                    <a href="<?=base_url('Petition/create')?>" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu"> Entry </span>
                                    </a>
                                </li>
                                ...
                                <li class="sidebar-item">
                                    <a href="<?=base_url('Petition')?>" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                ...
                                <?php if(in_array('mailbetweendate',$user_permission)){ ?>
                                <li class="sidebar-item">
                                    <a href="<?=base_url('Petition/search')?>" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu">Search Between Date</span>
                                    </a>
                                </li>  
                        ...
                        <li class="sidebar-item">
                            ...
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="fas fa-user fa-2x"></i>
                                &nbsp;&nbsp;&nbsp; <span class="hide-menu">Duty Constable</span>
                            </a>
                           
                            <ul aria-expanded="false" class="collapse  first-level">
                                <?php if(in_array('createdo',$user_permission)){ ?>
                                <li class="sidebar-item">
                                    <a href="<?=base_url('DutyConstable/create')?>" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu"> Entry </span>
                                    </a>
                                </li>
                                ...
                                <?php if(in_array('searchdo',$user_permission)){ ?>
                                <li class="sidebar-item">
                                    <a href="<?=base_url('DutyConstable')?>" class="sidebar-link">
                                        <i class="icon-Record"></i>
                                        <span class="hide-menu"> Search </span>
                                    </a>
                                </li>
