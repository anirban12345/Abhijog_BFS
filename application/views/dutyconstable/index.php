            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Duty Constable</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">All Duty Constable</li>                                 
                                </ol>
                            </nav>
                        </div>
                    </div>
...
$('#file_export').DataTable({   
    ...
    ajax: {
			type:'GET',
		    url: '<?=base_url('DutyConstable/getDutyConstable')?>',								
	      }
});
