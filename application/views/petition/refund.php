...
<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="alert alert-success fa-3x text-center">Docket No: <?=$petition[0]->p_ref_no?></div>                           
                    ...
                    <div class="table-responsive">
                                                <table id="file_export" class="table table-striped" >
                                                    ...
                                                    <?php $i=1; foreach($petition as $r) { ?>                                                                   
                                                                <tr>
                                                                    ...
                                                                    <td><?=$r->p_address?></td>
                                                                    <td><?=$r->p_mobile?></td>                                                                     
                                                                    <th><?=date('d-M-Y',strtotime($r->p_datefrom))?></th> 
                                                                    <th><?=date('d-M-Y',strtotime($r->p_dateto))?></th>             
                                                                    <th><?=$r->p_status?></th> 
                                                                    <th><?=$r->do_name?></th>                                                                                                                                                                    
                                                                    <th><?=$r->p_disposed?></th>
                                        ...
                                        <div class="table-responsive">
                                            <form action="<?=base_url('Petition/saveRefund')?>" method="post"> 
                                                <?php 
                                                    $csrf = array(
                                                ...
                                                <table id="file_export" class="table table-striped" >
                                                    ...
                                                    <?php $i=0; foreach($bankdtls as $r) { $i++; ?>                                                                   
                                                                <tr>
                                                                    ...
                                                                    <input type="hidden" id="bd_p_id" name="bd_p_id[]" value="<?=$r->bd_p_id?>">                                                                    
